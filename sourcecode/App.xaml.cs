...
namespace XML
{
    public partial class App : Application
    {
        ...
        {
            // Initialize BugSense
            BugSenseHandler.Instance.InitAndStartSession(new ExceptionManager(Current), RootFrame, "01502a0c");
            // vor release auskommentieren!
            // BugSenseHandler.Instance.HandleWhileDebugging = false;



            // Globaler Handler für nicht abgefangene Ausnahmen. --->> entsprechend der BugSense-Anleitung auskommentiert!
        ...
        {
            FlurryWP8SDK.Api.StartSession("RCFK8V2RKZGW6Y23JWDQ");
        }
        ...
        private void InitializeLanguage()
        {
            try
            {
                // WICHTIG WIEDER ENTFERNEN VOR VERÖFFENTLICHUNG!!!!
